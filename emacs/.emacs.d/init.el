...
;; tree-sitter sources and remapping
...
(use-package go-mode
  ...
  (use-package eglot
    ...
    :config
    (add-to-list 'eglot-server-programs '((go-mode))))
  ;;(add-to-list 'eglot-server-programs '((go-mode go-ts-mode) . ("pyright-langserver" "--stdio"))))
