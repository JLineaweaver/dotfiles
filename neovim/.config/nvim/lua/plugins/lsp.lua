return { -- LSP Configuration & Plugins
	{
		...
		config = function()
			-- LSP settings using LspAttach autocmd (new in nvim 0.11+)
			...
			-- Configure LSPs using new vim.lsp.config API
			for _, lsp in ipairs(defaults) do
				if lsp ~= 'gopls' then -- Skip gopls, we'll configure it separately
					vim.lsp.config(lsp, {
			...
			-- Go custom config using new API
