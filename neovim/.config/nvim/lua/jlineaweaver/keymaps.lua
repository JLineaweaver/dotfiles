...
general_map("n", "<leader><leader>x", ":lua require'jlineaweaver.globals'.save_and_exec()<CR>", general_default_opts)
...
local key_maps = {
  general = {
    ...
    { "n", "<C-n>", ":NvimTreeToggle <CR>", general_default_opts },
  ...
  lsp = {
    ...
    { "n", "<leader>rn", "<cmd>lua require('jlineaweaver.rename_prompt').rename()<CR>", lsp_default_opts },
...
vim.cmd([[ command! LspToggleAutoFormat execute 'lua require("jlineaweaver.format_cmds").toggle_format_on_save()' ]])
